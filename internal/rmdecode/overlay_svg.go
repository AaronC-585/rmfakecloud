...
func RenderRmOverlaySVG(data []byte) (string, error) {
	return RenderRmOverlaySVGWithImages(data, nil)
}

// RenderRmOverlaySVGWithImages is RenderRmOverlaySVG with inserted page images.
func RenderRmOverlaySVGWithImages(data []byte, images map[string][]byte) (string, error) {
	if len(data) == 0 {
